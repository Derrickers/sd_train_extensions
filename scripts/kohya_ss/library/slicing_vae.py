...
class SlicingAutoencoderKL(ModelMixin, ConfigMixin):
    ...
    This model inherits from [`ModelMixin`]. Check the superclass documentation for the generic methods the extensions.sd_train_extensions.scripts.kohya_ss.library
