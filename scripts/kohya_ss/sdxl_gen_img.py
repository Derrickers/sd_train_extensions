...
import extensions.sd_train_extensions.scripts.kohya_ss.library.sdxl_model_util as sdxl_model_util
...
from extensions.sd_train_extensions.scripts.kohya_ss.library.original_unet import FlashAttentionFunction
...
def main(args):
    ...
    if args.vae_slices:
        from extensions.sd_train_extensions.scripts.kohya_ss.library.slicing_vae import SlicingAutoencoderKL
