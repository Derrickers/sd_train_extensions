...
class PipelineLike:
    ...
    extensions.sd_train_extensions.scripts.kohya_ss.library implements for all the pipelines (such as downloading or saving, running on a particular device, etc.)
    Args:
        vae ([`AutoencoderKL`]):
