...
def train_model(
    ...
    if sdxl:
        run_cmd += f' "extensions/sd_train_extensions/scripts/kohya_ss/sdxl_train_network.py"'
    else:
        run_cmd += f' "extensions/sd_train_extensions/scripts/kohya_ss/train_network.py"'
